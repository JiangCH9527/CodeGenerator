...
import com.weidong.mybatis.config.PackageConfigType;
...
import com.weidong.mybatis.utils.FileUtil;
...
public class BaseGeneratorImpl implements Generator {
    ...
    public void initVelocityContext(VelocityContext velocityContext, GeneratorContext generatorContext) {
        ...
        titleSb.append("/** ").append(LINE)
                .append(" * " + generatorContext.getUpClassName()).append(LINE)
                .append(" * ").append(LINE)
                .append(" * AutoCreated on ").append(dateFormat.format(new Date())).append(LINE)
                .append(" */");
