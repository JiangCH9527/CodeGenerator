...
public class DefaultGeneratorConfigurer implements GeneratorConfigurer {
    ...
    protected void initPackage() {
        ...
        properties.setProperty("generator.basePackage", GENERATOR_BASEPACKAGE);
    }
    ...
    protected void initDomain() {
        String value = (String) properties.get("generator.domain.suffix");
        if (StringUtils.isNotBlank(value)) {
            return;
        }
        properties.setProperty("generator.domain.suffix", GENERATOR_DOMAIN_SUFFIX);
    }

    protected void initQueryDomain() {
        String value = (String) properties.get("generator.queryDomain.suffix");
        if (StringUtils.isNotBlank(value)) {
            return;
        }
        properties.setProperty("generator.queryDomain.suffix", GENERATOR_QUERY_DOMAIN_SUFFIX);
    }
